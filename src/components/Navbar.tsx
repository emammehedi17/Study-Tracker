    ...
    <header className="sticky top-0 z-40 w-full border-b border-stone-200 dark:border-stone-800 bg-white/95 dark:bg-stone-900/95 backdrop-blur-md transition-colors duration-200 shadow-xs">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          {/* Date Navigator */}
          <div className="flex items-center gap-1 bg-stone-100 dark:bg-stone-800 p-1 rounded-xl border border-stone-200/80 dark:border-stone-700/80">
            <button
              id="nav-prev-date-btn"
              onClick={() => handleShiftDate(-1)}
              className="p-1 rounded-lg text-stone-600 dark:text-stone-300 hover:bg-white dark:hover:bg-stone-700 transition"
              title="আগের দিন"
            >
              <ChevronLeft className="w-4 h-4" />
            </button>
            
            <div className="flex items-center gap-1.5 px-2 text-xs font-semibold text-stone-800 dark:text-stone-200">
